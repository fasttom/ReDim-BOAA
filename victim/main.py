...
vgg_model = train_model(train_set=train_loader, val_set=val_loader, model_name="vgg16", epochs=50)
resnet_model = train_model(train_set=train_loader, val_set=val_loader, model_name="resnet50", epochs=50)
vit_model = train_model(train_set=train_loader, val_set=val_loader, model_name="vit_tiny_patch16_224", epochs=50)
